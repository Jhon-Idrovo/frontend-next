export const es = {
  ...
  signUp: {
    ...
    usernameAdvice:
      "Usuario puede contener caracteres alfanumericos, _, @, +, . y - . Espacios no permitidos",
    passwordAdvice: "Espacios no permitidos",
...
export const en = {
  ...
  signUp: {
    ...
    usernameAdvice:
      "Username may contain alphanumeric, _, @, +, . and - characters. No spaces allowed",
    passwordAdvice: "No spaces allowed",
